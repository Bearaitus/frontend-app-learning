  ...
  <section className="text-dark-700 mb-4 rounded raised-card p-4">
    <div className="row w-100 m-0">
      <div className="col-12 col-sm-6 col-md-7 p-0">
        ...
        <p className="small">
          Здесь показано, насколько далеко вы продвинулись в изучении курса. Каждый выполненный шаг — это вклад в ваше развитие. Продолжайте изучать теоретические материалы и выполнять практические кейсы — вы уже проделали большую работу!
        </p>
      </div>
