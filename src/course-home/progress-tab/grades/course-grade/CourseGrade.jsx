      ...
      <div className={applyLockedOverlay} aria-hidden={gradesFeatureIsFullyLocked}>
        <div className="row w-100 m-0 p-4">
          <div className="col-12 col-sm-6 p-0 pr-sm-5.5">
            ...
            <p className="small">
              Здесь показано, насколько вы близки к проходному баллу. Каждый выполненный кейс приближает вас к цели. Следите за прогрессом вашей практики и продолжайте в том же духе!
            </p>
          </div>
